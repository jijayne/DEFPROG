...
class ExpenseTrackerApp:
    ...
    def create_widgets(self):
        ...
        # Additional Features
        ttk.Button(display_frame, text="Delete Expense", command=self.delete_expense).grid(row=7, column=0, pady=5)
    ...
    def delete_expense(self):
        ...
        if selected_item:
            ...
            self.update_budget_info()
            messagebox.showinfo("Delete Successful", "Expense deleted successfully!")
        else:
